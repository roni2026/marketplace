...
drop policy if exists "Select own reactions" on public.message_reactions;
...
drop policy if exists "Select own attachments" on public.message_attachments;
...
drop policy if exists "Insert own attachments" on public.message_attachments;
...
drop policy if exists "Select own archives" on public.conversation_archive;
create policy "Select own archives" on public.conversation_archive for select using (user_id = auth.uid());
drop policy if exists "Insert own archives" on public.conversation_archive;
create policy "Insert own archives" on public.conversation_archive for insert with check (user_id = auth.uid());
drop policy if exists "Delete own archives" on public.conversation_archive;
...
drop policy if exists "Select review replies" on public.review_replies;
...
drop policy if exists "Insert review replies" on public.review_replies;
...
drop policy if exists "Select followers" on public.seller_followers;
create policy "Select followers" on public.seller_followers for select using (true);
drop policy if exists "Insert own follow" on public.seller_followers;
create policy "Insert own follow" on public.seller_followers for insert with check (follower_id = auth.uid());
drop policy if exists "Delete own follow" on public.seller_followers;
