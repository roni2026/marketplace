...
drop policy if exists "Public can view listing variants" on public.listing_variants;
create policy "Public can view listing variants" on public.listing_variants for select using (true);
drop policy if exists "Ad owner manages variants" on public.listing_variants;
...
drop policy if exists "Users manage own templates" on public.listing_templates;
...
drop policy if exists "Ad owner inserts price history" on public.price_history;
...
drop policy if exists "Users manage own price drop alerts" on public.price_drop_alerts;
...
drop policy if exists "Public can view ad media" on public.ad_media;
create policy "Public can view ad media" on public.ad_media for select using (true);
drop policy if exists "Ad owner manages media" on public.ad_media;
...
drop policy if exists "Public can view ad locations" on public.ad_locations;
create policy "Public can view ad locations" on public.ad_locations for select using (true);
drop policy if exists "Ad owner manages locations" on public.ad_locations;
...
drop policy if exists "Users manage own media library" on public.media_library;
create policy "Users manage own media library" on public.media_library for all
  using (user_id = auth.uid()) with check (user_id = auth.uid());

-- Image optimizations: owner of the media item
drop policy if exists "Users manage own image optimizations" on public.image_optimizations;
