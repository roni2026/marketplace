...
import {
  ...
  Tv, Headphones, Tablet, Watch, Motorcycle, Bicycle, Truck, Ship,
...
export const CATEGORY_DATA: CategoryDef[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'motorcycles', name: 'Motorcycles', slug: 'motorcycles', icon: Motorcycle },
      { id: 'bicycles', name: 'Bicycles', slug: 'bicycles', icon: Bicycle },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'football-sports', name: 'Football', slug: 'football-sports', icon: Football },
      { id: 'cricket', name: 'Cricket', slug: 'cricket', icon: Trophy },
      { id: 'basketball-sports', name: 'Basketball', slug: 'basketball-sports', icon: Basketball },
      { id: 'tennis-sports', name: 'Tennis & Badminton', slug: 'tennis-sports', icon: Tennis },
      { id: 'cycling', name: 'Cycling', slug: 'cycling', icon: Bicycle },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'outdoor-toys', name: 'Outdoor Toys', slug: 'outdoor-toys', icon: Football },
