...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Compliance Dashboard', href: '/admin/compliance-dashboard', icon: ShieldCheck },
      { title: 'Revenue Analytics', href: '/admin/revenue-analytics', icon: TrendingUp },
      { title: 'Scheduled Reports', href: '/admin/scheduled-reports', icon: FileText },
