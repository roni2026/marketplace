...
values
 -- Account
 ('welcome', 'account', 'Welcome to BazarBD', 'Your account has been created successfully. Start buying and selling today!', 'Welcome to BazarBD', '

# Welcome to BazarBD!

Your account is ready. Start exploring the marketplace.

', 'Welcome to BazarBD! Your account is ready.', 'Welcome!', 'Your BazarBD account is ready', 'user-plus', '/dashboard', 'Get Started'),
 ('email_verified', 'account', 'Email Verified', 'Your email address has been verified successfully.', 'Email Verified', '

# Email Verified

Your email address has been confirmed.

', 'BazarBD: Your email has been verified.', 'Email Verified', 'Your email is now verified', 'badge-check', null, null),
 ...
 ('password_changed', 'account', 'Password Changed', 'Your password has been changed. If this was not you, please contact support.', 'Password Changed', '

# Password Changed

Your password was changed. If this was not you, contact support immediately.

', 'BazarBD: Your password was changed.', 'Password Changed', 'Your password was updated', 'lock', null, null),
 ('login_new_device', 'security', 'New Device Login', 'A login was detected from a new device. If this was not you, please secure your account.', 'New Device Login', '

# New Device Login

A new device logged into your account.

', 'BazarBD: Login from new device detected.', 'New Login', 'New device login detected', 'smartphone', '/settings/security', 'Review'),
 ('account_suspended', 'account', 'Account Suspended', 'Your account has been suspended. Contact support for more information.', 'Account Suspended', '

# Account Suspended

Your account has been suspended.

', 'BazarBD: Your account has been suspended.', 'Account Suspended', 'Your account was suspended', 'ban', '/support', 'Contact Support'),
 ('account_restored', 'account', 'Account Restored', 'Your account has been restored. Welcome back!', 'Account Restored', '

# Account Restored

Your account is active again.

', 'BazarBD: Your account has been restored.', 'Account Restored', 'Your account is active again', 'check-circle', null, null),
 -- Listings
 ('listing_approved', 'listings', 'Listing Approved', 'Your listing "{{listing_title}}" has been approved and is now live.', 'Listing Approved', '

# Listing Approved

Your listing is now live.

', 'BazarBD: Your listing was approved.', 'Listing Approved', 'Your listing is now live', 'check-circle', '/ad/{{listing_slug}}', 'View Listing'),
 ('listing_rejected', 'listings', 'Listing Rejected', 'Your listing "{{listing_title}}" was rejected. Reason: {{reason}}', 'Listing Rejected', '

# Listing Rejected

Your listing was rejected.

', 'BazarBD: Your listing was rejected.', 'Listing Rejected', 'Your listing was rejected', 'x-circle', '/my-ads', 'View Listings'),
 ...
 ('listing_expires_soon', 'listings', 'Listing Expires Soon', 'Your listing "{{listing_title}}" will expire in {{days}} days.', 'Listing Expires Soon', '

# Listing Expiring Soon

Your listing will expire soon. Renew it to keep it live.

', 'BazarBD: Your listing expires in {{days}} days.', 'Expiring Soon', 'Listing expires in {{days}} days', 'clock', '/my-ads', 'Renew'),
 ('listing_expired', 'listings', 'Listing Expired', 'Your listing "{{listing_title}}" has expired.', 'Listing Expired', '

# Listing Expired

Your listing has expired. Renew it to make it visible again.

', 'BazarBD: Your listing has expired.', 'Listing Expired', 'Your listing has expired', 'x-circle', '/my-ads', 'Renew'),
 ...
 ('listing_sold', 'listings', 'Listing Sold', 'Your listing "{{listing_title}}" has been marked as sold.', 'Listing Sold', '

# Listing Sold

Congratulations! Your item has been sold.

', 'BazarBD: Your listing was sold.', 'Listing Sold', 'Your item was sold', 'shopping-bag', '/my-ads', 'View'),
 ...
 ('offer_accepted', 'offers', 'Offer Accepted', 'Your offer for "{{listing_title}}" has been accepted.', 'Offer Accepted', '

# Offer Accepted

Your offer was accepted!

', 'BazarBD: Your offer was accepted.', 'Offer Accepted', 'Your offer was accepted', 'check-circle', '/ad/{{listing_slug}}', 'View'),
 ...
 -- Saved Searches
 ('saved_search_match', 'saved_searches', 'New Matching Listing', 'A new listing matches your saved search "{{search_name}}".', 'New Matching Listing', '

# New Matching Listing

A new listing matches your search.

', 'BazarBD: New listing matches your search.', 'New Match', 'New listing matches your search', 'search', '/search', 'View'),
 ...
 -- Wishlist
 ('wishlist_price_drop', 'wishlist', 'Price Drop', 'The price for "{{listing_title}}" dropped from {{old_price}} to {{new_price}}.', 'Price Drop', '

# Price Drop!

An item on your wishlist dropped in price.

', 'BazarBD: Price drop on your wishlist item.', 'Price Drop', 'Price dropped to {{new_price}}', 'trending-down', '/ad/{{listing_slug}}', 'View'),
 ...
 -- Orders (Shop Only)
 ('new_order', 'orders', 'New Order', 'You received a new order #{{order_id}}.', 'New Order', '

# New Order

You received a new order.

', 'BazarBD: New order #{{order_id}} received.', 'New Order', 'Order #{{order_id}} received', 'shopping-cart', '/shop-dashboard/orders', 'View Order'),
 ...
 ('order_completed', 'orders', 'Order Completed', 'Order #{{order_id}} has been completed.', 'Order Completed', '

# Order Completed

Order #{{order_id}} is complete.

', 'BazarBD: Order #{{order_id}} completed.', 'Order Completed', 'Order #{{order_id}} complete', 'check-circle', '/shop-dashboard/orders', 'View'),
 -- Payments (Shop Only)
 ('payment_received', 'payments', 'Payment Received', 'Payment of {{amount}} received for order #{{order_id}}.', 'Payment Received', '

# Payment Received

Payment of {{amount}} received.

', 'BazarBD: Payment received for order #{{order_id}}.', 'Payment Received', 'Payment of {{amount}} received', 'dollar-sign', '/shop-dashboard/payments', 'View'),
 ...
 ('payment_failed', 'payments', 'Payment Failed', 'Payment for order #{{order_id}} has failed.', 'Payment Failed', '

# Payment Failed

Payment for order #{{order_id}} failed.

', 'BazarBD: Payment failed for order #{{order_id}}.', 'Payment Failed', 'Payment for order #{{order_id}} failed', 'x-circle', '/shop-dashboard/payments', 'Retry'),
 ('refund_completed', 'payments', 'Refund Completed', 'Refund of {{amount}} for order #{{order_id}} has been completed.', 'Refund Completed', '

# Refund Completed

Refund of {{amount}} processed.

', 'BazarBD: Refund completed for order #{{order_id}}.', 'Refund Completed', 'Refund of {{amount}} processed', 'rotate-ccw', '/shop-dashboard/payments', 'View'),
 ...
 ('order_shipped', 'delivery', 'Order Shipped', 'Order #{{order_id}} has been shipped.', 'Order Shipped', '

# Order Shipped

Your order has been shipped.

', 'BazarBD: Order #{{order_id}} shipped.', 'Order Shipped', 'Order #{{order_id}} shipped', 'truck', '/shop-dashboard/orders', 'Track'),
 ('out_for_delivery', 'delivery', 'Out for Delivery', 'Order #{{order_id}} is out for delivery.', 'Out for Delivery', '

# Out for Delivery

Your order is out for delivery.

', 'BazarBD: Order #{{order_id}} out for delivery.', 'Out for Delivery', 'Order #{{order_id}} out for delivery', 'truck', '/shop-dashboard/orders', 'Track'),
 ('delivered', 'delivery', 'Delivered', 'Order #{{order_id}} has been delivered.', 'Order Delivered', '

# Order Delivered

Your order has been delivered.

', 'BazarBD: Order #{{order_id}} delivered.', 'Delivered', 'Order #{{order_id}} delivered', 'check-circle', '/shop-dashboard/orders', 'View'),
 ('delivery_failed', 'delivery', 'Delivery Failed', 'Delivery for order #{{order_id}} has failed.', 'Delivery Failed', '

# Delivery Failed

Delivery for your order failed.

', 'BazarBD: Delivery failed for order #{{order_id}}.', 'Delivery Failed', 'Delivery for order #{{order_id}} failed', 'x-circle', '/shop-dashboard/orders', 'View'),
 ...
 -- System
 ('system_maintenance', 'system', 'Scheduled Maintenance', 'The platform will undergo maintenance on {{maintenance_time}}.', 'Scheduled Maintenance', '

# Scheduled Maintenance

BazarBD will undergo maintenance.

', 'BazarBD: Scheduled maintenance on {{maintenance_time}}.', 'Maintenance', 'Scheduled maintenance on {{maintenance_time}}', 'wrench', null, null),
